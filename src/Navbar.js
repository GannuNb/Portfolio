      ...
      <div className="nav-container">
        ...
        <div className={`nav-links-wrapper ${showMobileMenu ? "show" : ""}`}>
          <div className="nav-links">
            ...
            {/* About Dropdown */}
            <div
              className={`nav-item about-item ${isActive("/about") || isActive("/skills") ? "active-link" : ""}`}
            ...
            >
              ...
              {showAboutDropdown && (
                <div className="dropdown-menu-custom">
                  <Link to="/about" className="dropdown-link" onClick={() => setShowMobileMenu(false)}>
                    Education
                  </Link>
                  <Link to="/skills" className="dropdown-link" onClick={() => setShowMobileMenu(false)}>
                    Skillset
                  </Link>
                </div>
              )}
            ...
            <Link
              to="/experience"
              className={`nav-item ${isActive("/experience") ? "active-link" : ""}`}
              onClick={() => setShowMobileMenu(false)}
            >
              Experience
            </Link>
            ...
            <Link
              to="/projects"
              className={`nav-item ${isActive("/projects") ? "active-link" : ""}`}
              onClick={() => setShowMobileMenu(false)}
            >
              Projects
            </Link>
